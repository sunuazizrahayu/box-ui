...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="/webui/assets/img/icon-trim.png">
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <a href="/auth/logout.php" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=current_url() ?>"><i class="fa fa-circle-o"></i> Overview</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Version</b> 1.0.3-rc
    </div>
    <strong>BOX-UI &copy; <?=date('Y') ?> by <a href="https://github.com/sunuazizrahayu/box-ui">kangsunu</a>.</strong> All rights reserved.
  </footer>
...
$(function() {
  ...
  menuItem.parents('.treeview').addClass('active menu-open'); // If the menu item is within a treeview
});
</script>
@yield('js')
</body>
